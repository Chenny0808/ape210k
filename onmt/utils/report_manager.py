...
class ReportMgrBase(object):
    ...
    def report_training(self, step, num_steps, learning_rate,
                        report_stats, multigpu=False, report_stats_sni=None):
        """
        ...
        if step % self.report_every == 0:
            ...
            self._report_training(
                step, num_steps, learning_rate, report_stats, report_stats_sni)
            self.progress_step += 1
            return onmt.utils.Statistics(), onmt.utils.Statistics()
        else:
            return report_stats, report_stats_sni
...
class ReportMgr(ReportMgrBase):
    ...
    def _report_training(self, step, num_steps, learning_rate,
        ...
        report_stats_sni.output_sni(step, num_steps, learning_rate, self.start_time)
