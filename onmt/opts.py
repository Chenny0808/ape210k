...
def model_opts(parser):
    ...
    group.add('--model_class', '-model_class', default='sni',
              choices=['nmt', 'sni'],
              help='Data class of the model.')
    ...
    group.add('--dec_rnn_size', '-dec_rnn_size', type=int, default=300,
              help="Size of decoder rnn hidden states. "
                   ...
                   "speech-to-text.")
    group.add('--out_class', '-out_class', type=int, default=2,
              help="Number of classification type.")
...
def train_opts(parser):
    ...
    group.add('--data', '-data', default="data/infix/has_rel/math-math23k",
    ...
    group.add('--pre_word_vecs_enc', '-pre_word_vecs_enc', default="data/infix/embeddings-math23k.enc.pt",
              help="If a valid path is specified, then this will load "
                   "pretrained word embeddings on the encoder side. "
                   "See README for specific formatting instructions.")
    group.add('--pre_word_vecs_dec', '-pre_word_vecs_dec', default="data/infix/embeddings-math23k.dec.pt",
              help="If a valid path is specified, then this will load "
